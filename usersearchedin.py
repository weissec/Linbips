...
# Uersearchedin v1.1
# Retrieve potential usernames from linkedin for a password spray
# W315 (C) 2019
...
test = '''
Given a target company name, retrieves a list of potential usernames from Linkedin using a google dork.
